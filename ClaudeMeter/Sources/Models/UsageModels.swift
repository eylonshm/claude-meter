...
enum AppConstants {
    static let appGroupIdentifier = "group.com.claudemeter.shared"
    static let widgetBundleIdentifier = "com.claudemeter.app.widget"
    static let widgetDataFilename = "widget-data.json"
    static let widgetKind = "ClaudeMeterWidget"
}
