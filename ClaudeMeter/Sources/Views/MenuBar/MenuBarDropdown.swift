...
struct MenuBarDropdown: View {
    ...
    private var permissionDeniedBanner: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text("Claude Meter needs access to read your stats from **~/.claude/**. Open Privacy & Security settings and enable access for Claude Meter under **Files and Folders**.")
